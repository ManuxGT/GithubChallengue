...
public class UsersActivity extends AppCompatActivity implements UsersContract.View, UsersAdapter.ListItemClick {
...
//        mPresenter.fetchUserList();
    ...
    public void onListItemClick(int clickedItem) {
        Intent intent = new Intent(UsersActivity.this, ReposActivity.class);
        intent.putExtra("username", usersAdapter.getUsers().get(clickedItem).getLogin());
        startActivity(intent);
